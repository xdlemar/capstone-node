-- Safe rebuild of ALMS prototype tables (drops tolerate pre-existing schema)

-- ensure legacy tables are gone without failing when they never existed
DO $$ BEGIN
...
EXCEPTION WHEN OTHERS THEN
  -- ignore; the intent is to continue even if these tables never existed
  NULL;
END $$;
